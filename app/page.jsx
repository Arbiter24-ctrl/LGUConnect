...
export default function HomePage() {
  return (
    ...
    >
      ...
      {/* Navigation */}
      <nav className="bg-white/90 backdrop-blur-sm shadow-sm border-b fixed top-0 left-0 w-full z-20">
      ...
      {/* Add padding to the top of the page content to prevent overlay */}
